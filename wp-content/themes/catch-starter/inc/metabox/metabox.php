...
class Catch_Starter_Metabox {
	...
	*/
	public function show() {
	    ...
	    <div id="catch-starter-ui-tabs" class="ui-tabs">
		    <ul class="catch-starter-ui-tabs-nav" id="catch-starter-ui-tabs-nav">
		    	<li><a href="#frag3"><?php esc_html_e( 'Header Featured Image Options', 'catch-starter' ); ?></a></li>
		    	<!-- <li><a href="#frag4"><?php esc_html_e( 'Single Page/Post Image Layout ', 'catch-starter' ); ?></a></li> -->
		    </ul>
	    	<div id="frag3" class="catch_ad_tabhead">
		    	<table id="header-image-metabox" class="form-table" width="100%">
		            <tbody>
		                <tr>
		                    <?php
		                    $metaheader = get_post_meta( $post->ID, 'catch-starter-header-image', true );
		                    ...
		                    ?>
		                        <td style="width: 100px;">
		                            <label class="description">
		                                <input type="radio" name="catch-starter-header-image" value="<?php echo esc_attr( $field ); ?>" <?php checked( $field, $metaheader ); ?>/>&nbsp;&nbsp;<?php echo esc_html( $label ); ?>
		                            </label>
		                        </td>
	...
	public function enqueue_metabox_scripts( $hook ) {
	    ...
	    //Scripts
		wp_enqueue_script( 'catch-starter-metabox-script', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'inc/metabox/metabox.js', array( 'jquery', 'jquery-ui-tabs' ), '2017-08-15' );

		//CSS Styles
		wp_enqueue_style( 'catch-starter-metabox-style', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'inc/metabox/metabox.css' );
	}
}
