...
function catch_starter_scripts() {
	...
	wp_enqueue_style( 'catch-starter-ie', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'assets/css/ie.css', array( 'catch-starter-style' ), '20160816' );
	wp_style_add_data( 'catch-starter-ie', 'conditional', 'lt IE 10' );

	// Load the Internet Explorer 8 specific stylesheet.
	wp_enqueue_style( 'catch-starter-ie8', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'assets/css/ie8.css', array( 'catch-starter-style' ), '20160816' );
	wp_style_add_data( 'catch-starter-ie8', 'conditional', 'lt IE 9' );

	// Load the Internet Explorer 7 specific stylesheet.
	wp_enqueue_style( 'catch-starter-ie7', trailingslashit( esc_url ( get_template_directory_uri() ) ) . 'assets/css/ie7.css', array( 'catch-starter-style' ), '20160816' );
	wp_style_add_data( 'catch-starter-ie7', 'conditional', 'lt IE 8' );
